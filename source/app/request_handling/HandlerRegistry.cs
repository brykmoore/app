...
namespace app.request_handling
{
  public class HandlerRegistry : IGetHandlersForRequests
  {
    ...
    public HandlerRegistry(IEnumerable<IHandleOneRequest> all_the_handlers, ICreateTheMissingHandler missing_handler_builder)
    {
      this.all_the_handlers = all_the_handlers;
      this.missing_handler_builder = missing_handler_builder;
    }

    public HandlerRegistry():this(new StubHandlers(), StubRequestHandlingDelegates.missing_handler_builder)
    {
    }
